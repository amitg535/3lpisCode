...
public interface ILoginManagement {
	...
	/**
	 * This method is used to retrieve User Details 
	 * @author PallaviD
	 * @param emailID
	...
	public List<LoginManagementDom> getUsers(String string);
	...
	public void updateBetaUserStatus(String emailId, String string);
