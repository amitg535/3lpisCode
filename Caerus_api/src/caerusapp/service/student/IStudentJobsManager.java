...
public interface IStudentJobsManager extends Serializable {
	...
	/*public Map<String, Date> getAppliedInternshipIdsMap(String loggedInUserEmail);

	public Map<String, Date> getSavedJobIdsMap(String loggedInUserEmail);

	public Map<String, Date> getSavedInternshipIdsMap(String loggedInUserEmail);*/

	/*Map<String, Date> getAppliedJobIdsMap(String candidateEmailId);*/

	public StudentDom getDefaultProfileDetails(String loggedInUserEmail);

	public Map<String, Date> getSavedAndAppliedJobIdsMap(String loggedInUserEmail);

	public void saveJob(String jobId, String candidateEmailId);

	public void applySavedJob(String jobId, String candidateEmailId);

	void applyJob(String jobId, String candidateEmailId);
	...
	public void applySavedInternship(String internshipId,String candidateEmailId);

	public Integer getCandidateAppliedPosition(Set<String> keySet,String emailId);
	...
	/**
	 * This method Fetches the saved jobs of a candidate
	 * @author BalajiI 
	 * @param emailId
	 * @return List<JobDetailsDom(savedJobs)
	 */
