package caerusapp.command.university;
 ...
 * @author RavishaG
 */
public class UniversityDetailsCom {

	@NotEmpty(message=ValidatorMessageConstants.UNIVERSITY_NAME_EMPTY)
	...
	@Length(min = 6,max = 16,message=ValidatorMessageConstants.PHONE_NUMBER_SIZE)
