package caerusapp.command.student;
...
public class StudentCom implements Serializable 
{
	...
	@NotEmpty(message = ValidatorMessageConstants.PASSWORD_EMPTY)
	...
	@NotEmpty(message = ValidatorMessageConstants.CONFIRM_PASSWORD_EMPTY)
	...
	private String jobid_and_firmid;
	...
	private List<JobDetailsCom> jobList;
	...
	/**
	 * @param primarySkills1
	 *            the primarySkills1 to set
	 */
	...
	/**
	 * @param secondarySkills1
	 *            the secondarySkills1 to set
	 */
	...
	/**
	 * @param profileDefault
	 *            the profileDefault to set
	 */
	...
	public String getJobid_and_firmid() {
		return jobid_and_firmid;
	}

	public void setJobid_and_firmid(String jobid_and_firmid) {
		this.jobid_and_firmid = jobid_and_firmid;
	}
	 ...
	 * @return the jobList
	 */
	public List<JobDetailsCom> getJobList() {
		return jobList;
	}
	 ...
	 */
	public void setJobList(List<JobDetailsCom> jobList) {
