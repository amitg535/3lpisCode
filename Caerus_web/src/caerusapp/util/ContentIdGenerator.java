...
/**
 * This class is used to generate a unique identifier using the hostname, the current time, and a sequence number to avoid collision.
 *
 */
public class ContentIdGenerator {
  ...
  /**
   * This method is used to generate content Id
   * @param args
