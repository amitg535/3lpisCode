...
public class EmployerCampusInternshipValidator  implements Validator {
	...
	public void validate(Object command, Errors errors) {
		...
		if(internshipDetailsCom.getCampusJobRecipients() == null || (internshipDetailsCom.getCampusJobRecipients() != null && internshipDetailsCom.getCampusJobRecipients().get(0).trim().length() == 0))
