...
public class EmployerJobValidator implements Validator {
	...
	public void validate(Object command, Errors errors) {
		...
		if(jobDetailsCom.getExperienceTo() == null || (jobDetailsCom.getExperienceTo() != null && jobDetailsCom.getExperienceTo().trim().length() == 0))
			errors.rejectValue("experienceTo","error.employer.jobDetailsCom.experienceTo.required","Please Enter Experience To");
		
		if(jobDetailsCom.getExperienceFrom() == null || (jobDetailsCom.getExperienceFrom() != null && jobDetailsCom.getExperienceFrom().trim().length() == 0))
			errors.rejectValue("experienceFrom","error.employer.jobDetailsCom.experienceFrom.required","Please Enter Experience From");
