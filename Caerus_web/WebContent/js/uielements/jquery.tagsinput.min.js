(function (a) {
    ...
    a.fn.addTag = function (d, e) {
        ...
        this.each(function () {
            ...
            if (e.unique) {
            	...
            	/*
            	 * Start
            	 * Modified by KARTHIKEYANK on 11/07/2013
            	*/
        			 d=d.replace('[', '');
        			 ...
        			 if(d==""){
        				...
        				// alert("Tag:"+("#" + f + "_tagsinput")); 
        				 
        				 setTimeout(function(){
        					 $('#' + f + '_tagsinput').find('.tag').remove();
                ...
                a("<span>").addClass("tag").append(a("<span>").addClass("tt").text(d), a("<a>", {
                    href: "#",
                    title: "Removing tag",
                    text: " x"
    ...
    a.fn.tagsInput = function (d) {
        var e = jQuery.extend({
            interactive: true,
            defaultText: "add Skill and press Enter",
            minChars: 0,
           // width: "300px",
           // height: "100px",
            autocomplete: {
