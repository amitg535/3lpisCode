...
<div id="wrap"> 
   ...
   <!--  <div id="innerbanner_wrap">
    ...
    <div id="innersection">
        ...
        <h1 class="sectionheading"> <c:out value="${internshipTitle}"/> at <c:out value="${companyName}"/> <c:out value="${location}"/> <span>(<c:out value="${count}"/>)</span></h1>
        ...
        <table width="100%" border="0" cellspacing="0" cellpadding="0" class="responseslisting">       
            ...
            <tr class="bg whitebackground" >
                ...
                <div class="details_wrap">
                    ...
                    <a href = "detail_view_candidate.htm?studentEmailId=<c:out value="${listForCandidate.emailID}"/>&internshipIdAndFirmId=<%=request.getParameter("internshipIdAndFirmId")%>&universityName=<%=request.getParameter("universityName")%>&campus=true"/> 
                    <c:out value="${listForCandidate.firstName}"></c:out> <c:out value="${listForCandidate.lastName}"></c:out>  , 
                    <c:out value="${listForCandidate.city}"></c:out> , <c:out value="${listForCandidate.state}"></c:out></a>
                     <div class="clear"></div>
                ...
                <fmt:parseDate value="${listForCandidate.appliedDate}" type="DATE" pattern="dd-MM-yyyy" var="formatedDate"/>
