...
<div id="main_wrap">
  ...
  <div id="mid_wrap" class="midwrap_toppadding">
   <%--  <div id="submenu">
    ...
    <h1 class="page_heading">Edit <span class="orange_font">Job</span></h1>
    <!--13-08-2013-->
           ...
           <div class="labeldetails">
            ...
            <c:choose>
                  <c:when test="${not empty copyJob && copyJob }">
                  	<form:input path="jobId" id="jobId" />
                  </c:when>	
                  
                  <c:otherwise>
                  	<form:input path="jobId" readonly="true" id="jobId" />
                  </c:otherwise>
                  </c:choose>
                  	<form:errors path="jobId" />
           
           
        <%--     <form:input path="jobId" id="jobId" placeholder="Job Id *" tabindex="1"/>  --%>
          ...
          <div class="labeldetails"> 
            ...
            <li>
             <div class="labeldetails"> 
             	...
             	<c:choose>
              		...
              		<c:otherwise>
              			<form:input path="jobTitle" readonly="true" id="jobTitle" />
              		</c:otherwise>
              		</c:choose>
           ...
           <li>
            	...
            	<div class="labeldetails"> 
        			 <form:select path="jobType" cssClass="chzn-select list_widthstyle1">
             ...
             <div class="labeldetails">   	
               <form:select path="industry" cssClass="chzn-select list_widthstyle1">
					...
					<c:forEach var="industry" items="${industryList}">
                         ...
                         <spring:bind path="postJob.industry"><c:set var = "industrySelected" value="${status.value}"/></spring:bind>
                    
                   <c:choose>
                      <c:when test="${industry == industrySelected}">
        ...
        <div class="innerform">
          <ul class="form_wrap">
            <li class="text_center">
                ...
                <input name="previewBtn" type="button" value="Preview"  class="orangebuttons" onclick="previewJob()">
