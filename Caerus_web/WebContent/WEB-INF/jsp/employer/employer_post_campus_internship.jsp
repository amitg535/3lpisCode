       ...
       <span class="errorblock"><c:out value="${param.msg}"></c:out>  </span>
			...
			<div id="innersection">
				<!-- <div id="breadcrums_wrap">
					You are here: <a href="employer_dashboard.htm">Home</a> / <a href="employer_jobs_internships.htm?selected=campusInternships">Publish
						Jobs &amp; Internships </a> / Publish an Internship to Campus
				</div> -->
			<%-- 	<section id="leftsection" class="floatleft">
				...
				<div class="whitebackground">
					...
					<p class="description">Post an Internship exclusively to the
						students in the Campus of your choice spread across United States.</p>
					...
					<div id="candidate_registration_wrap">
						<form:form class="stdform" action="employer_post_campus_internship.htm"  method="post" modelAttribute="campusInternshipCommand"  id="postInternshipForm" >
							<div class="leftsection_form">
								<div class="par">
								<input type="hidden" value="${campusInternshipCommand.internshipIdAndFirmId}" name="internshipIdAndFirmId">
								<input type="hidden" value="${campusInternshipCommand.campusInternshipAppliedStudents.size()}" name="responseCount">
								<input type="hidden" value="${campusInternshipCommand.universityName}" name="universityName">
								...
								<div class="par">
									...
									<form:select tabindex="3" path="internshipType" data-placeholder="Choose an Option" class="chzn-select list_widthstyle1">
								...
								<div class="par">
									...
									<div class="clear"></div>
									<span class="field"> <form:input path="numberOfVacancy" tabindex="8" class="input-medium" />
								...
								<div class="par">
									<label class="floatleft">Primary Skills Required</label> <span
										class="star">*</span>
									<div class="clear"></div>
									<span class="field"> <form:input tabindex="10" path="primarySkills"
											id="tags" class="input-large" />
							...
							<div class="rightsection_form">
								...
								<div class="par">
									...
									<div class="clear"></div>
									<span class="field"> <form:input tabindex="7" path="payPerHour"
											class="input-medium" />
									</span>
								</div>
								<div class="par">
